...
hoverText: "Formatted Text: {(noRef Formatted Text refers to a document or text that has been processed and arranged to have a specific layout, style, and presentation, making it visually appealing and easy to read.)}"
hoverText: "Formatted Text: {(noRef {glossaryText})}"
synonymOf:
grouptags:
