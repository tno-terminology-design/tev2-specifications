...
- installing the [tev2-toolbox](/docs/category/specs/tools);
- integrating the [tools](/docs/category/specs/tools) with other tools, such as a CI/CD pipeline on github or gitlab, static site generators such as [github pages](https://pages.github.com/) or [Docusaurus](https://docusaurus.io/docs/docs-introduction), etc. See also: [Using the Tools](/docs/category/specs/tools).
