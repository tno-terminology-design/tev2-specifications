...
While [TermRefs](@) have a [default syntax](/docs/spec-syntax/term-ref-syntax), alternative syntaxes can be used by choosing (or specifying) the [interpreter](@) that the [TRRT](@) should be using.
