...
The [TRRT specifications](/docs/40-specs/tools/trrt#term-ref-resolution) specify
...
- `term` (optional) is a [term](@). If not specified, its value is constructed based on the value of `showtext`, as specified in the [TRRT](/docs/40-specs/tools/trrt#id).
