...
[MRDs](@) are meant to be processed by the other tools in the [toolbox](/docs/category/specs/tools), specifically by one of the [HRDTs](@), which would then create a [Human Readable Dictionary](@) (or [HRD](@)).
