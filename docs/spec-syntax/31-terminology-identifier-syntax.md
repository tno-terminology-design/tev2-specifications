...
[^1]: When a [terminology](@) [is being constructed](/docs/spec-syntax/terminology-construction), the empty string [identifies](@) the [terminology that is under construction](terminology-under-construction)(@).
